    ...
    for (int i = 0; i < settings.NumTriangles; ++i) {
        ...
        if (status == dialling) {
            ...
            if (settings.isLCEModeEnabled && !settings.isDialingFromAnsatzEnabled) {
                double dirAng = (1.0 - currDialInFactor) * programmedMetricInfoSequence[progTensorSequenceCounter][i](0) +
                ...
                double lambda = (1.0 - currDialInFactor) * programmedMetricInfoSequence[progTensorSequenceCounter][i](1) +
            ...
            triangles[i].dialledProgTau = (1.0 - currDialInFactor) * programmedTausSequence[progTensorSequenceCounter][i] +
                                          currDialInFactor * programmedTausSequence[progTensorSequenceCounter + 1][i];
            triangles[i].dialledProgSecFF =
                    (1.0 - rootCurrDialInFactor) * programmedSecondFundamentalFormSequence[progTensorSequenceCounter][i] +
